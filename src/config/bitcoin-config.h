...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The CounosCoin Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "CounosCoin Core"
...
#define PACKAGE_BUGREPORT "https://github.com/counoscoin-project/counoscoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "CounosCoin Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "CounosCoin Core 0.13.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "counoscoin"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://counoscoin.org/"
