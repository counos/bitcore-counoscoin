...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "validateaddress \"counoscoinaddress\"\n"
            "\nReturn information about the given counoscoin address.\n"
            "\nArguments:\n"
            "1. \"counoscoinaddress\"     (string, required) The counoscoin address to validate\n"
            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,       (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"counoscoinaddress\", (string) The counoscoin address validated\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw runtime_error(
            "verifymessage \"counoscoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"
            "\nArguments:\n"
            "1. \"counoscoinaddress\"  (string, required) The counoscoin address to use for the signature.\n"
